...
class NewUpdateCRT : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_new_update_crt)
        languageToLoad = "mr"
        if (AppSettings.getLanguage(this@NewUpdateCRT).equals("1", ignoreCase = true)) {
            Log.d("getStrName=", AppSettings.getLanguage(this@NewUpdateCRT))
            languageToLoad = "en"
        }
        init()
        ...
        val adapter = ClimateGridAdapter(this, climateModelArrayList,"NewUpdateCRT")
        ...
        imgBackArrow?.setOnClickListener(View.OnClickListener {
            val intent = Intent(this, NewUpdateKharip::class.java)
            startActivity(intent)
        })
    }
