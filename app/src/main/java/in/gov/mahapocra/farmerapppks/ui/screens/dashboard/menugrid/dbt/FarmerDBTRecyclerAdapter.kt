...
class FarmerDBTRecyclerAdapter(private val farmersJSONArray: JSONArray,
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        val activityName = farmerObject.getString("activityName")
        holder.bind(activityName, farmerObject)
    }

    class ViewHolder(private val binding: FarmersDbtItemViewBinding,
                     private val listener: OnMultiRecyclerItemClickListener) : RecyclerView.ViewHolder(binding.root) {
