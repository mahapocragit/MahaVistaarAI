...
public class CropDetailsAdpter extends RecyclerView.Adapter<in.gov.mahapocra.farmerapppks.adapter.CropDetailsAdpter.ViewHolder> {
        ...
        @NonNull
        @Override
        public in.gov.mahapocra.farmerapppks.adapter.CropDetailsAdpter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(mContext).inflate(R.layout.single_cropadvisory_details, parent, false);
            return new in.gov.mahapocra.farmerapppks.adapter.CropDetailsAdpter.ViewHolder(view);
        }

        @Override
        public void onBindViewHolder(@NonNull in.gov.mahapocra.farmerapppks.adapter.CropDetailsAdpter.ViewHolder holder, int position) {
