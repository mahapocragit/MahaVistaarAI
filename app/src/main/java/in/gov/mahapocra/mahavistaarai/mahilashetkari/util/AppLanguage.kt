...
object Strings {
    ...
    data class Apply(
        ...
        // %1$s name, %2$s dob, %3$s village, %4$s taluka, %5$s district, %6$s mobile, %7$s aadhaar
    ...
    fun apply(lang: AppLanguage) = if (lang == AppLanguage.EN)
        Apply(
            ...
            declaration = "I, Smt./Ms. %1\$s, born on %2\$s. I am ordinarily residing at Village %3\$s, Taluka %4\$s, District %5\$s, within the jurisdiction of the %3\$s Village Panchayat. My mobile number is %6\$s. My Aadhaar Number is %7\$s, which I furnish for the purpose of Aadhaar-based electronic Know Your Customer (e-KYC) verification.\n\nI declare that I am engaged in above selected activities referred to in subsection (a) or subsection (d) of section 2 of the Maharashtra Women Farmers Empowerment Act, 2026, and that the particulars furnished by me regarding my agricultural or allied activities are true and correct.\n\nOn the basis of the particulars furnished above, I hereby apply under sub-section (1) of section 5 of the Maharashtra Women Farmers Empowerment Act, 2026, for recognition as a Woman Farmer and for the issue of a Woman Farmer Certificate.\n\nI verify that the particulars furnished above are true and correct to the best of my knowledge and belief. This application shall be authenticated through Aadhaar OTP.",
        ...
        Apply(
            ...
            sendOtp = "OTP पाठवा",
            sendOtpIn = "%d सेकंदांनी पुन्हा प्रयत्न करा",
            ...
            resendOtpIn = "%d सेकंदांनी पुन्हा प्रयत्न करा",
            ...
            declaration = "मी, सौ./कु. %1\$s, जन्मतारीख %2\$s. मी सर्वसाधारणपणे गाव %3\$s, तालुका %4\$s, जिल्हा %5\$s येथे राहते, जे %3\$s ग्रामपंचायतीच्या कार्यक्षेत्रात येते. माझा मोबाइल क्रमांक %6\$s आहे. माझा आधार क्रमांक %7\$s आहे, जो मी आधार-आधारित इलेक्ट्रॉनिक नो युवर कस्टमर (e-KYC) पडताळणीसाठी सादर करत आहे.\n\nमी जाहीर करते की मी वर निवडलेल्या, महाराष्ट्र महिला शेतकरी सक्षमीकरण अधिनियम, २०२६ च्या कलम २ च्या उप-कलम (अ) किंवा उप-कलम (ड) मध्ये नमूद केलेल्या कामांमध्ये गुंतलेली आहे, आणि माझ्या शेती किंवा शेतीपूरक कामांबाबत मी दिलेली माहिती खरी व बरोबर आहे.\n\nवर दिलेल्या माहितीच्या आधारे, मी महाराष्ट्र महिला शेतकरी सक्षमीकरण अधिनियम, २०२६ च्या कलम ५ च्या उप-कलम (१) अंतर्गत महिला शेतकरी म्हणून मान्यता आणि महिला शेतकरी प्रमाणपत्र मिळण्यासाठी अर्ज करत आहे.\n\nमी पडताळणी करते की वर दिलेली माहिती माझ्या माहिती व विश्वासानुसार खरी व बरोबर आहे. हा अर्ज आधार OTP द्वारे प्रमाणित केला जाईल.",
    ...
    data class ChatBot(
        ...
        val verifyingFarmerId: String,
        val farmerIdVerified: String,
    ...
    fun chatBot(lang: AppLanguage) = if (lang == AppLanguage.EN)
        ChatBot(
            ...
            verifyingFarmerId = "Checking that Farmer ID...",
            farmerIdVerified = "Verified — Farmer ID belongs to %s.",
        ...
        ChatBot(
            ...
            verifyingFarmerId = "फार्मर आयडी तपासत आहे...",
            farmerIdVerified = "पडताळणी झाली — हा फार्मर आयडी %s यांच्या नावे आहे.",
