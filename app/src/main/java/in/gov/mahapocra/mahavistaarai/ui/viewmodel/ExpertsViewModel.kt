...
class ExpertsViewModel : ViewModel() {
    ...
    fun uploadArticle(context: Context, file: MultipartBody.Part, title: String, description: String, category: String, subcategory: String) {
        viewModelScope.launch {
            try {
                ...
                val response = apiService.uploadArticle(file, titlePart, descPart, categoryPart, subcategoryPart, userPart)
