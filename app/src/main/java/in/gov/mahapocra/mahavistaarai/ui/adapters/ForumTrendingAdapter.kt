...
import `in`.gov.mahapocra.mahavistaarai.databinding.ItemTrendingForumBinding
import `in`.gov.mahapocra.mahavistaarai.ui.screens.dashboard.forum.ForumViewActivity
