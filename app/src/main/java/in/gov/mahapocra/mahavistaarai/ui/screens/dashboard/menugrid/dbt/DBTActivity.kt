                ...
                when (event.action) {
                    ...
                    MotionEvent.ACTION_UP -> {
                        ...
                        if (diffX < CLICK_THRESHOLD && diffY < CLICK_THRESHOLD) {
                            if (!isGuest) {
                                startActivity(Intent(this@DBTActivity, ChatbotActivity::class.java))
                            } else {
                                AlertDialog.Builder(this@DBTActivity)
                                    .setMessage(R.string.bot_chat_login_redirect_mesage)
                                    .setPositiveButton(R.string.yes) { dialog, _ ->
                                        startActivity(Intent(this@DBTActivity, LoginScreen::class.java).apply {
