...
public interface AppConstants {
    ...
    String kMName  = "kMName";
    String kLName  = "kLName";
    String kLevel  = "kLevel";
    String kSwitch  = "kSwitch";
    String kDesignation  = "kDesignation";
    String kDist  = "kDist";
    String kVillageName  = "kVillageName";
    String kVillageCensus  = "kVillageCensus";
    ...
    String kCA_ATTENDANCE = "kCA_ATTENDANCE";
    String kCA_ATTENDANCE_Fname = "kCA_ATTENDANCE_Fname";
    String kTC_ATTENDANCE = "kTC_ATTENDANCE";
    String kCA_ATTENDANCE_ID = "kCA_ATTENDANCE_ID";
    String kCA_ATTENDANCE_IN_TIMESTAMP = "kCA_ATTENDANCE_IN_TIMESTAMP";
    String kCA_CLUSTER_DATA = "kCA_CLUSTER_DATA";
    ...
    String kSLED_FARMER_ID = "kSLED_FARMER_id";
    String kSLED_FARMER_NAME = "kSLED_FARMER_NAME";
    String kSLED_FARMER_LEVEL = "kSLED_FARMER_LEVEL";
