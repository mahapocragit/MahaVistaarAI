...
import `in`.gov.mahapocra.farmerapp.ui.adapters.FertilizersRecyclerAdapter
...
import `in`.gov.mahapocra.farmerapp.databinding.ActivityFertilizerCalculatorActivityBinding
