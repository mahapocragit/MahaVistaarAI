package `in`.gov.mahapocra.farmerapp.ui.screens.dashboard.menugrid.soilhealthcard
...
import `in`.gov.mahapocra.farmerapp.ui.adapters.FarmerAdapter
...
import `in`.gov.mahapocra.farmerapp.databinding.ActivityHealthCardBinding
