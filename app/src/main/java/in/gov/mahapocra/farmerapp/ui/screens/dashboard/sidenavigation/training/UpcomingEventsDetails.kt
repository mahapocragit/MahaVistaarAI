package `in`.gov.mahapocra.farmerapp.ui.screens.dashboard.sidenavigation.training
...
import `in`.gov.mahapocra.farmerapp.ui.adapters.AdaptorSelectedCoCoord
import `in`.gov.mahapocra.farmerapp.ui.adapters.AdaptorSelectedCoordinator
...
import `in`.gov.mahapocra.farmerapp.data.model.TrainingDetailModel
