...
import `in`.gov.mahapocra.farmerapp.ui.adapters.TemperatureAdapter
import `in`.gov.mahapocra.farmerapp.ui.adapters.ViewPagerAdapter
import `in`.gov.mahapocra.farmerapp.util.app_util.AppConstants
import `in`.gov.mahapocra.farmerapp.databinding.ActivityWeatherHomeTempBinding
