...
public class Farmer_profile extends AppCompatActivity {
    ...
    private static final String TAG = "Farmer_profile";
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_farmer_profile1);
        ...
        custom_grid_adapter1 adapter1 = new custom_grid_adapter1(Farmer_profile.this, web, imageId);
        ...
        grid.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (position == 0) {
                    ...
                    Intent intent6 = new Intent(Farmer_profile.this, expert_list.class);
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                       // Log.d(TAG, "DocumentSnapshot successfully written!");
                        Toast.makeText(Farmer_profile.this, "Token updated", Toast.LENGTH_LONG).show();
                    }
                })
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.signout) {
            ...
            Intent intent = new Intent(Farmer_profile.this, Login_VideoCalling.class);
            startActivity(intent);

            shared_pref.remove_shared_preference(Farmer_profile.this);
            return true;
        }
...
// Remove the 'capital' field from the document
        ...
        docRef.update(updates)
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                       // Log.d(TAG, "DocumentSnapshot successfully written!");
                        Toast.makeText(Farmer_profile.this, "Token Deleted.", Toast.LENGTH_LONG).show();
                    }
                })
                .addOnFailureListener(new OnFailureListener() {
                    @Override
                    public void onFailure(@NonNull Exception e) {
                       // Log.w(TAG, "Error writing document", e);
                        ...
                        Toast.makeText(Farmer_profile.this, "Token not Deleted.", Toast.LENGTH_LONG).show();
                    }
                });
    }
}