...
public class annotation_adapter_validator extends RecyclerView.Adapter<annotation_adapter_validator.MyViewHolder> {
    ...
    public annotation_adapter_validator(Context context,
                              ArrayList<String> point_x1_list,
                              ArrayList<String> point_y1_list,
                              ArrayList<String> point_x2_list,
                              ArrayList<String> point_y2_list,
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.annotation_layout_validator, parent, false);
