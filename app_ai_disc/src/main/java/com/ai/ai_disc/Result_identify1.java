...
import com.ai.ai_disc.Farmer.QueryDetails;
...
public class Result_identify1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button rate=findViewById(R.id.feed);
...
//            get image path
            try {
                if (Uri.parse(ob.getImage_url()) != null)
                {
                    ...
                    Toast.makeText(Result_identify1.this, "Not found", Toast.LENGTH_SHORT).show();
                }
            } catch (Exception e)
            {
                Toast.makeText(Result_identify1.this, "Please upload valid image", Toast.LENGTH_LONG).show();
            }
            if (!ob.isError()) {
...
//                    ##### Healthy type
                        ...
                        final android.app.AlertDialog.Builder popDialog1 = new android.app.AlertDialog.Builder(Result_identify1.this);
                        ...
                        popDialog1.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                dialog.dismiss();
//                                Intent gotopage =new Intent(Result_identify1.this, farmerdiseasepestIdentify1.class);
...
//        }
        ...
        AndroidNetworking.post("https://nibpp.krishimegh.in/Api/nibpp/setrate")
                ...
                .getAsJSONObject(new JSONObjectRequestListener() {
                    ...
                    public void onResponse(JSONObject jsonObject) {
                        ...
                        if (res){
                            Toast.makeText(Result_identify1.this, "Thank you for your feedback.", Toast.LENGTH_SHORT).show();
    ...
    {
        AlertDialog.Builder poy=new AlertDialog.Builder(Result_identify1.this);
        poy.setTitle("Want to go back ?")
        ...
        AndroidNetworking.post("https://nibpp.krishimegh.in/Api/nibpp/Managment_Practices_pest")
                ...
                .getAsJSONArray(new JSONArrayRequestListener() {
                    ...
                    public void onError(ANError anError) {
                        ...
                        Toast.makeText(Result_identify1.this, "Error", Toast.LENGTH_LONG).show();
                    }
                });
...
*/
                            ...
                            for (int i = 0; i < management_practices_diseaseList.size(); i++)
                            {
                                ...
                                if (management_practices_diseaseList.get(i).getSymptoms() != null && !management_practices_diseaseList.get(i).getSymptoms().equals("NA")) {
                                    symptoms_Text.setText(management_practices_diseaseList.get(i).getSymptoms());
                                ...
                                if (management_practices_diseaseList.get(i).getCultural_Text() != null && !management_practices_diseaseList.get(i).getCultural_Text().equals("NA")) {
                                    cultural_Text.setText(management_practices_diseaseList.get(i).getCultural_Text());
                                ...
                                if (management_practices_diseaseList.get(i).getChemical_Text() != null && !management_practices_diseaseList.get(i).getChemical_Text().equals("NA")) {
                                    chemical_Text.setText(management_practices_diseaseList.get(i).getChemical_Text());
                                ...
                                if (management_practices_diseaseList.get(i).getBiological_Text() != null && !management_practices_diseaseList.get(i).getBiological_Text().equals("NA")) {
                                    biological_Text.setText(management_practices_diseaseList.get(i).getBiological_Text());
                            ...
                            {
                                Diseases_Layout_main.setVisibility(View.GONE);
                                Toast.makeText(Result_identify1.this, "No management practices found for this disease", Toast.LENGTH_SHORT).show();
                            }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.logout:
                ...
                Intent intent = new Intent(Result_identify1.this, Login.class);
                startActivity(intent);
                finish();

                shared_pref.remove_shared_preference(Result_identify1.this);
