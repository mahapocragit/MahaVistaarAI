...
public class uploadimagereport extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_upload_reportimage);
        //getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        setTitle("Upload Images");
        internet = new InternetReceiver();
        ButterKnife.bind(this);
        marray=getIntent().getParcelableArrayListExtra("array");
        layout_bottom_sheet=findViewById(R.id.layout_bottomsheet);
        reportid=getIntent().getExtras().getInt("report");
        ...
        galleryAdapter1 = new GalleryAdapter_report1(uploadimagereport.this, marray,reportid);
        RecyclerView.LayoutManager mLayoutManager = new LinearLayoutManager(uploadimagereport.this);
        ...
        select_image.setOnClickListener(new View.OnClickListener() {
                                            @Override
                                            public void onClick(View view) {
                                                Dexter.withActivity(uploadimagereport.this)
                                                        ...
                                                        .withListener(new PermissionListener() {
                                                            ...
                                                            public void onPermissionDenied(PermissionDeniedResponse response) {
                                                                ...
                                                                Toast.makeText(uploadimagereport.this, "Permission is required.", Toast.LENGTH_LONG).show();
                                                                // }
                                                            }
                                ...
                                .withListener(new MultiplePermissionsListener() {
                                    ...
                                    public void onPermissionsChecked(MultiplePermissionsReport report) {
                                        ...
                                        if (report.areAllPermissionsGranted()) {
                                            ...
                                            Intent intent = new Intent(uploadimagereport.this, CAM2.class);
    ...
    public void onBackPressed() {
        AlertDialog.Builder dp = new AlertDialog.Builder(uploadimagereport.this);
        dp.setTitle("On Back Report will be lost... wanna proceed to back ?");
        dp.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialogInterface, int i) {
                Intent ijh =new Intent(uploadimagereport.this, farmersprofile_fragment.class);
                startActivity(ijh);
            }
        ...
        switch (requestcode) {
            ...
            case 1:
                ...
                if (requestcode == SELECT_IMAGE_CODE && responsecode == RESULT_OK && data != null) {
                    ...
                    if (data.getData() != null) {
                        ...
                        marray.add(mImageUri);


                        Intent ijh =new Intent(uploadimagereport.this,uploadimagereport.class);
                        ijh.putParcelableArrayListExtra("array",marray);
                        ijh.putExtra("report",reportid);
                        startActivity(ijh);
                    ...
                    Toast.makeText(uploadimagereport.this, "File is not selected. ", Toast.LENGTH_LONG).show();
                }
            ...
            case 4:
                ...
                if (requestcode == TAKE_IMAGE_CODE && responsecode == RESULT_OK && data != null) {
                    ...
                    Toast.makeText(uploadimagereport.this, "Some Error.", Toast.LENGTH_LONG).show();
