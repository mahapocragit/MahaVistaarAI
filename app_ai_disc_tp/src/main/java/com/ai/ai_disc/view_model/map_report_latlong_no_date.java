...
public class map_report_latlong_no_date extends ViewModel {

    private static final String TAG = "latlong put";
    public MutableLiveData<reportmap_latlong_response> list;

    public LiveData<reportmap_latlong_response> getting_crops(int crop_id, int dp_id,int typ,String startdate,String enddate) {
        // if (list == null) {
        list = new MutableLiveData<reportmap_latlong_response>();
        getcrops(crop_id, dp_id,typ, startdate, enddate);
        // }
        return list;
    }


    public void getcrops(int crop_id, int dp_id,int typ,String startdate,String enddate) {
        ...
        AndroidNetworking.post("https://nibpp.krishimegh.in/Api/nibpp/get_report_date_info")
