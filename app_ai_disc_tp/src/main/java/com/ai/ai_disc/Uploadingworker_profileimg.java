...
public class Uploadingworker_profileimg extends Worker {

    private static final String TAG = "Uploadingworker";
    Context context;
    final int chunkSize = 2048;

    public Uploadingworker_profileimg(@NonNull Context context, @NonNull WorkerParameters workerParams) {
    ...
    public Result doWork() {
        ...
        String user_name = getInputData().getString("user_name");
        return upload_image_data_synchronous(context, converting_string(context, url), id,user_name);
                            ...
                            {
{
  ...
  "result": true
    ...
    private Result upload_image_data_synchronous(Context ctx, String file_path_string, String record_id,String user_name) {
      ...
      //  Log.i(TAG, "inside from uploading is " + Thread.currentThread().getName());
        ...
        String image_name=user_name+getAlphaNumericString();
        String image_proper = file_path_string.replaceAll("\n", "");
        JSONObject object = new JSONObject();
        try {
            object.put("user_id", record_id);
            object.put("image_path", image_proper);
            object.put("image_name", image_name);
 ...
 */
        ...
        ANRequest request = AndroidNetworking.post("https://nibpp.krishimegh.in/Api/nibpp/Add_image_profile")
                .addJSONObjectBody(object)
                .build();
