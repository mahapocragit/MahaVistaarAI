...
public class farmerdiseasepestIdentify1 extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    LinearLayout severity_layout,disease_layout,headview;
...
//            title_disease.setVisibility(View.GONE);
        ...
        another.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent gotopage =new Intent(farmerdiseasepestIdentify1.this, farmerdiseasepestIdentify1.class);
        ...
        progressDialog=new ProgressDialog(farmerdiseasepestIdentify1.this);
        ...
        upload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                url_model="https://aidisc.krishimegh.in:32103/"+url;
...
//                                                    Log.d("Google Model Output:",obj.toString());
                                                ...
                                                if (!obj.isEmpty()) {
                                                   // Log.d(TAG, "not empty");
                                                    ...
                                                    if (obj.contains("Plant") || obj.contains("Vegetable") || obj.contains("Fruit") || obj.contains("Insect")) {
                                                        ...
                                                        if (obj.contains("Forest") || obj.contains("Jungle")) {
        ...
        take_photo.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v) {
                ...
                if (checking_permision()) {
                    ...
                    Intent intent = new Intent(farmerdiseasepestIdentify1.this, CAM2.class);
        ...
        select_from_gallery.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (ContextCompat.checkSelfPermission(farmerdiseasepestIdentify1.this, Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
                    ActivityCompat.requestPermissions(farmerdiseasepestIdentify1.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE}, 0);
...
//                                model.setPest_present(response.has("one"));
                            ...
                            Intent intent = new Intent(farmerdiseasepestIdentify1.this, Result_identify1.class);
                    ...
                    public void onError(ANError error) {
                        ...
                        progressDialog.cancel();
//                        Toast.makeText(farmerdiseasepestIdentify.this, "Error", Toast.LENGTH_LONG).show();
                        final AlertDialog.Builder popDialog1 = new AlertDialog.Builder(farmerdiseasepestIdentify1.this);
...
//                        Toast.makeText(farmerdiseasepestIdentify.this, "Error !!! ", Toast.LENGTH_LONG).show();
//
//                        disease_prediction_model model = new disease_prediction_model();
//
//                        model.setError(true);
//                        Gson gson = new Gson();
//                        String myJson = gson.toJson(model);
...
//                        startActivity(intent);
    ...
    public boolean checking_permision() {
        ...
        if ((ContextCompat.checkSelfPermission(farmerdiseasepestIdentify1.this, Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) || (ContextCompat.checkSelfPermission(farmerdiseasepestIdentify1.this, Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED)) {
            ActivityCompat.requestPermissions(farmerdiseasepestIdentify1.this, new String[]{Manifest.permission.CAMERA, Manifest.permission.WRITE_EXTERNAL_STORAGE}, 1);
    ...
    public void converting_string(String file_path) {
        ...
        if (!file_path.isEmpty()) {
            ...
            try {
                ...
                e.printStackTrace();
                Toast.makeText(farmerdiseasepestIdentify1.this, "Error in converting ", Toast.LENGTH_LONG).show();
                file_path_string = "";
            }
        } else {
...
//        System.out.println("url111" + url_model);
        ...
        AndroidNetworking.post("https://aidisc.krishimegh.in:32103/detect_crops")
                .addJSONObjectBody(object)
                .build()
                .getAsJSONObject(new JSONObjectRequestListener()
                {
                    ...
                    public void onResponse(JSONObject response)
                    {
                        ...
                        try {
                            ...
                            if (paths.matches("")){
                                Toast.makeText(farmerdiseasepestIdentify1.this, "Error", Toast.LENGTH_LONG).show();
                            }else {
                                if (response.optBoolean("result")) {
                                    ...
                                    final String[] listItems = new String[]{ "Proceed with " + crop, "Proceed with " + crops, "Try Again" };
                                    ArrayList<Integer> slist = new ArrayList();
//                                    boolean icount[] = new boolean[options.length];

                                    final AlertDialog.Builder popDialog = new AlertDialog.Builder(farmerdiseasepestIdentify1.this);
                                    popDialog.setIcon(R.drawable.errro_2);
//                                    new code
                                    popDialog.setTitle("Warning!!! " + crops +" crop detected");
...
//                        Toast.makeText(farmerdiseasepestIdentify.this, "Error", Toast.LENGTH_LONG).show();
    ...
    public void onBackPressed() {
        Intent gotopage =new Intent(farmerdiseasepestIdentify1.this, Farmer_Disease_identifier_pest_Identifier_Activity.class);
        startActivity(gotopage);
        ...
        switch (requestcode) {
            ...
            case 1:
                ...
                if (requestcode == 1 && responsecode == RESULT_OK && data != null) {
                    ...
                    Toast.makeText(farmerdiseasepestIdentify1.this, "File is not selected.", Toast.LENGTH_LONG).show();
                }
            ...
            case 4:
                ...
                if (requestcode == 4 && responsecode == RESULT_OK) {
                    ...
                    Toast.makeText(farmerdiseasepestIdentify1.this, "No image captured", Toast.LENGTH_LONG).show();
    ...
    public void show_dialog(String message) {
        ...
        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(farmerdiseasepestIdentify1.this);
    ...
    private void signout() {
        AlertDialog.Builder opt = new AlertDialog.Builder(farmerdiseasepestIdentify1.this);
        opt.setTitle("Are you sure ?");
        opt.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialogInterface, int i) {
                shared_pref.remove_shared_preference(farmerdiseasepestIdentify1.this);
                Intent intent = new Intent(farmerdiseasepestIdentify1.this, Login.class);
                startActivity(intent);
                finish();
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
        switch (menuItem.getItemId()) {
            case R.id.about_us1:
                ...
                Intent intent = new Intent(farmerdiseasepestIdentify1.this, About_us1.class);
                startActivity(intent);
            ...
            case R.id.help1:
                ...
                Intent intent1 = new Intent(farmerdiseasepestIdentify1.this, needHelp.class);
            ...
            case R.id.editme:
                ...
                Intent ibt=new Intent(farmerdiseasepestIdentify1.this, editprofile.class);
                startActivity(ibt);

                break;
            case R.id.contributor:

                Intent ibt1=new Intent(farmerdiseasepestIdentify1.this, contributor.class);
                startActivity(ibt1);
            ...
            case R.id.history:
                ...
                Intent ibtw=new Intent(farmerdiseasepestIdentify1.this, editprofile.class);
                startActivity(ibtw);
