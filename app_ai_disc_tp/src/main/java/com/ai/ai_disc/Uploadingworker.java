...
public class Uploadingworker extends Worker {
    ...
    public Uploadingworker(@NonNull Context context, @NonNull WorkerParameters workerParams) {
 ...
 */
        ...
        ANRequest request = AndroidNetworking.post("https://nibpp.krishimegh.in/Api/nibpp/Add_image_data")
                .addJSONObjectBody(object)
                .build();
