...
public class Uploadingworker_report extends Worker {

    private static final String TAG = "Uploadingworker_report";
    Context context;
    final int chunkSize = 2048;

    public Uploadingworker_report(@NonNull Context context, @NonNull WorkerParameters workerParams) {
 ...
 */
        ...
        AndroidNetworking.post("https://nibpp.krishimegh.in/Api/nibpp/Add_report_data")
                            ...
                            {
{
  ...
  "result": true
    ...
    private Result upload_image_data_synchronous(Context ctx, String file_path_string, String record_id) {
        ...
        try {
            object.put("record_id", record_id);
            object.put("image_path", image_proper);
            object.put("mac_address", GetMacAddress.getMacAddr());
 ...
 */
        ...
        ANRequest request = AndroidNetworking.post("https://nibpp.krishimegh.in/Api/nibpp/Add_report_data")
                .addJSONObjectBody(object)
                .build();
