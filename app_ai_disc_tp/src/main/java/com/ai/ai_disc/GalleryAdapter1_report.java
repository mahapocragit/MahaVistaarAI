...
public class GalleryAdapter1_report extends RecyclerView.Adapter<GalleryAdapter1_report.MyViewHolder> {
    ...
    public GalleryAdapter1_report(Context ctx, ArrayList<Uri> mArrayUri,int report_id) {
        ...
        holder.upload_compress_image.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Data data = new Data.Builder()
                        ...
                        .putString("id", Data1.record_id)
                        .build();

                OneTimeWorkRequest mRequest = new OneTimeWorkRequest.Builder(Uploadingworker.class)
