...
import com.ai.ai_disc.MultiChat_adminQuery_Activity;
...
public class custom_adapter_admin_chat extends BaseAdapter {
        ...
        public custom_adapter_admin_chat(Context context, List<QueryDetails1> queryDetailsList){
    ...
    @Override
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            user.setText("Farmer: ' "+queryDetailsList.get(position).getFirstName()+" '");
...
//            }
            ...
            status_vc.setText("Check");
            status_vc.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent = new Intent(context, MultiChat_adminQuery_Activity.class);
//
