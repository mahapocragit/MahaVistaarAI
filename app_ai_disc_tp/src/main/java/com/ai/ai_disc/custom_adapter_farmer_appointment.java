...
public class custom_adapter_farmer_appointment extends RecyclerView.Adapter<custom_adapter_farmer_appointment.MyViewHolder>  {
    ...
    private final String[] slots=new String[]{"10 - 10:30 ",
            "10:30 - 11 ",
            "11 - 11:30 ",
            "11:30  - 12 ","12 - 12:30 ",
            "12:30 - 13 ",
    ...
    private final String[] slotss=new String[]{"10:00",
            "10:30",
            "11:00",
            "11:30",
            "12:00",
    ...
    public custom_adapter_farmer_appointment(farmer_appointment list_account, ArrayList<getall_appoinment_model> listAccountInfos)
    {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder myViewHolder, int i) {
        ...
        if (status.matches("0")){
            ...
            myViewHolder.call.setEnabled(true);
